...
export const faqData: FAQCategory[] = [
    {
        ...
        mappedSlugs: ["roof-cleaning", "commercial-roof-cleaning"],
        faqs: [
            {
    ...
    {
        service: "Pressure & Soft Washing",
        mappedSlugs: ["pressure-washing", "commercial-pressure-washing", "building-washing", "house-washing", "concrete-cleaning", "dumpster-pad-cleaning", "graffiti-removal", "storefront-cleaning"],
        faqs: [
            {
    ...
    {
        service: "Paver Restoration",
        mappedSlugs: ["paver-patio-restorations", "rust-removal"],
        faqs: [
            {
    ...
    {
        service: "Permanent LED Lighting",
        mappedSlugs: ["christmas-lighting", "permanent-led-lighting", "residential-permanent-led-lighting"],
        faqs: [
            {
