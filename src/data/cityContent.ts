...
export const cityData: CityContent[] = [
    {
        ...
        introParagraph: "Operating near the vibrant College Avenue district or the bustling Fox River mall in Appleton means maintaining an immaculate professional image. Appleton's commercial and residential properties face unique Wisconsin weather challenges—from heavy spring pollen that coats storefronts to freezing winter precipitation. Valley Property Services specializes in eliminating these specific Fox Valley environmental buildups.",
    ...
    },
    {
        ...
        introParagraph: "Properties in Green Bay and the surrounding Fox Valley face a brutal combination of urban and natural stressors. During our harsh Wisconsin winters, atomized road salt affixes to exterior surfaces, aggressively corroding window frames and architectural metals. As we transition into humid summers, the moisture from the bay and the Fox River creates the perfect breeding ground for Gloeocapsa magma—the highly destructive cyanobacteria responsible for the aggressive black streaking on asphalt shingle roofs. We utilize specialized, low-pressure soft washing and biodegradable algaecides to safely neutralize these biological threats without damaging your siding.",
        ...
        conclusionParagraph: "Valley Property Services is Titletown's premier 5-star exterior restoration unit. Whether you need a massive commercial concrete pad renewed or a delicate residential roof washed safely, our certified technicians deliver unparalleled results across the greater Green Bay region.",
    ...
    
    {
        ...
        conclusionParagraph: "Don't risk expensive water damage to your Neenah home's foundation or roofline. Valley Property Services provides the critical preventative maintenance required to keep your water diversion systems flowing efficiently and your home looking pristine.",
    ...
    
    {
        ...
        conclusionParagraph: "From the historic districts to standard suburban layouts, Oshkosh home and business owners trust Valley Property Services to provide safe, highly effective exterior surface sanitization.",
    ...
    
    {
        ...
        introParagraph: "The Door County peninsula presents entirely unique exterior maintenance challenges. Flanked by Lake Michigan and the bay, the persistent lakefront humidity aggressively promotes fungi and mildew on historic timber structures and painted cedar shingles. Furthermore, this waterfront environment fuels intense lakefront spider populations. Our specialized soft washing methodology operates under 100 PSI, utilizing proprietary surfactants to eradicate mold and eliminate persistent pest webbing without inflicting mechanical damage, stripping paint, or causing water intrusion into your delicate cedar substrate.",
        ...
        conclusionParagraph: "From massive coastal estates to bustling boutique storefronts, Valley Property Services delivers the most comprehensive, high-end exterior restoration available across the entire Door County peninsula.",
    ...
    },
    {
        ...
        conclusionParagraph: "Do not let the harsh coastal environment permanently degrade your Manitowoc home or business. Valley Property Services provides the ultimate architectural defense through professional, high-efficiency exterior cleaning.",
