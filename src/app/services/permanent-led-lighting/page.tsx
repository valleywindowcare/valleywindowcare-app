...
export default function PermanentLEDLightingPage() {
    return (
        <main className="min-h-screen bg-white">
                ...
                <div className="container mx-auto px-4 relative z-20 flex flex-col items-center justify-center text-center">
                    <div className="max-w-4xl mb-12">
                        <h1 className={`text-4xl md:text-5xl lg:text-7xl font-extrabold leading-tight mb-6 tracking-tight drop-shadow-lg mx-auto text-white`}>
                            Professional <span className="text-gold">Permanent LED Lighting</span><br />
                        ...
                        <p className="text-lg md:text-xl text-gray-100 mb-8 font-semibold leading-relaxed drop-shadow-md">
                            Valley Window Care and Exterior Cleaning provides premium permanent led lighting services to enhance your property's value.
                        </p>
                    </div>
                    {/* Hero Form Stack */}
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "provider": {
                                ...
                                "image": "https://valleywindowcare.com/images/portfolio/permanent-lighting-night-suamico.webp",
                                "telephone": "(920) 609-7085",
                                "url": `https://valleywindowcare.com/services/permanent-led-lighting`
                            },
                            "areaServed": [
            ...
            {serviceContentMap['permanent-led-lighting']?.pricing && (
                <PricingMatrix {...serviceContentMap['permanent-led-lighting'].pricing} />
            )}
            <VanillaMapClient />
            </div>
            
            <FAQAccordion
                faqs={faqData["permanent-led-lighting"] || faqData["christmas-lighting"] || []}
            />
        </main>
    );
}
