...
export const metadata = {
    title: "Professional Soft Wash | Valley Window Care",
...
export default function ServicePage() {
    ...
    return (
        <main className="w-full overflow-hidden bg-slate-50">
                    ...
                    <section className="mb-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 not-prose">
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-soft border border-gray-100 relative overflow-hidden group hover:border-gold/30 transition-colors">
                                ...
                                <p className="text-gray-600 relative z-10 leading-relaxed">
                                    We apply our proprietary soft wash mix. We use specialized low-pressure pumps. The algicide eliminates the deeply rooted mold spores.
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-8 rounded-2xl shadow-soft border border-gray-100 relative overflow-hidden group hover:border-gold/30 transition-colors">
                                ...
                                <p className="text-gray-600 relative z-10 leading-relaxed">
                                    We wash away the dead organic matter. We use standard garden-hose pressure. We guarantee zero water gets trapped behind your siding.
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-16 bg-[#FFFFFF] text-[#1E2B3C] p-8 md:p-12 rounded-3xl not-prose shadow-[0_0_40px_rgba(30,43,60,0.06)] border border-gray-100">
                        ...
                        <div className="space-y-6 mt-10">
                            ...
                            <div className="flex gap-4 items-start">
                                ...
                                <div>
                                    <h4 className="text-xl font-bold text-navy-dark mb-2">Vinyl Siding</h4>
                            ...
                            <div className="flex gap-4 items-start">
                                <CheckCircle className="text-gold shrink-0 mt-1" size={24} />
                                <div>
                                    <h4 className="text-xl font-bold text-navy-dark mb-2">Stucco & Dryvit</h4>
                                    <p className="text-gray-600 leading-relaxed">We wash porous architectural exteriors. High pressure blasts holes in stucco. We kill the green algae safely.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4 items-start">
                                <CheckCircle className="text-gold shrink-0 mt-1" size={24} />
                                <div>
                                    <h4 className="text-xl font-bold text-navy-dark mb-2">Painted Wood</h4>
                                    <p className="text-gray-600 leading-relaxed">We restore painted timber surfaces. We eradicate the black mildew stains. We preserve your expensive paint job completely.</p>
                                </div>
                            </div>
                        </div>
                    </section>
            ...
            {serviceContentMap['soft-wash']?.pricing && (
                <PricingMatrix {...serviceContentMap['soft-wash'].pricing} />
            )}
            <ReviewSlider />
