...
export const metadata: Metadata = {
    title: "Driveway Cleaning | Valley Window Care and Exterior Cleaning",
    description: "Valley Window Care and Exterior Cleaning provides premium Driveway Cleaning in Northeast Wisconsin.",
    alternates: {
        canonical: "https://valleywindowcare.com/services/driveway-cleaning"
    }
};
        ...
        <>
            <div className="bg-navy text-gray-300 py-3 text-xs md:text-sm uppercase tracking-wider font-semibold border-b border-navy-dark relative z-20">
                <div className="container mx-auto px-4 max-w-7xl flex items-center gap-2 overflow-x-auto whitespace-nowrap scrollbar-hide">
                    ...
                    <ChevronRight size={14} className="opacity-50 flex-shrink-0" />
                    <span className="text-gold">Driveway Cleaning</span>
                </div>
            </div>

            <Hero
                h1={<>Driveway Cleaning</>}
                description="Providing premium exterior services across Northeast Wisconsin."
                bgImage="/gallery/audit-replacements/audit-1772396199144-839.webp"
            />
