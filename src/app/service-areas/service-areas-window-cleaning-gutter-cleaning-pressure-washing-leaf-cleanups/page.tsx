...
export const metadata = {
    title: "service areas window cleaning gutter cleaning pressure washing leaf cleanups | Valley Window Care",
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-navy mb-6 tracking-tight capitalize">
                        service areas window cleaning gutter cleaning pressure washing leaf cleanups
                    </h1>
