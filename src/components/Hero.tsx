                ...
                <div className="max-w-4xl mb-12">
                    ...
                    {showTrustBadges && (
                        <div className="mt-6 flex flex-wrap justify-center gap-4 text-xs sm:text-sm font-bold text-white relative z-10">
                          <div className="bg-slate-900/90 text-white border border-slate-700/60 px-3.5 py-1.5 rounded-full shadow-md font-semibold text-xs md:text-sm flex items-center gap-2">
