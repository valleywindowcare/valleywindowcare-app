                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="flex flex-col justify-center space-y-8">
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed">
                            If you aren’t absolutely thrilled with the curb appeal of your home, we will come back and make it right. No questions asked. We utilize advanced soft washing and professional <Link href="/services/pressure-washing" className="text-navy font-bold hover:text-gold underline decoration-gold/60">Power &amp; Pressure Washing</Link> techniques designed specifically to safely eradicate dirt, grime, moss, and algae without causing structural damage.
                        </p>
                        <div className="pt-4">
