    ...
    return (
        <header className={headerClasses}>
            ...
            <div className="hidden lg:flex w-full bg-navy text-white border-b border-navy-light py-2 px-4 lg:px-8 xl:px-16 items-center text-[10px] xl:text-xs tracking-wider uppercase">
                <div className="mr-auto font-black text-gold tracking-widest pl-1 lg:text-[12px] xl:text-[14px]">Valley Property Services | Exterior Restoration & Pressure Washing</div>
            ...
            <div className="container mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 flex items-center justify-between min-h-[64px] md:min-h-[80px] py-2 md:py-3 lg:py-5">
                ...
                <Link href="/" aria-label="Home" className="shrink-0 hover:opacity-90 transition-opacity z-40 py-1 flex items-center relative max-w-[560px] max-h-[120px]">
                    <Image
                        ...
                        width={560}
                        height={120}
                        className="object-contain object-left w-auto h-20 sm:h-24 xl:h-28 shrink-0"
                        priority
                    />
                </Link>
                            ...
                            <div className="flex p-6">
                                ...
                                <div className="flex-1 pr-6 border-r border-gray-100">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <Link href="/services/gutter-cleaning" className="px-4 py-2 hover:bg-slate-50 rounded-xl text-navy-dark hover:text-gold transition-colors font-semibold">Gutter Cleaning</Link>
                                        <Link href="/services/gutter-guards" className="px-4 py-2 hover:bg-slate-50 rounded-xl text-navy-dark hover:text-gold transition-colors font-semibold">Gutter Guard Installation</Link>
                                ...
                                <div className="flex-1 pl-6">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <Link href="/services/barn-cleaning" className="px-4 py-2 hover:bg-slate-50 rounded-xl text-navy-dark hover:text-gold transition-colors font-semibold">Barn &amp; Agricultural Cleaning</Link>
                            ...
                            {isServicesOpen && (
                                <div className="pl-4 pb-4 space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <Link onClick={() => setIsMobileMenuOpen(false)} href="/services/gutter-cleaning" className="block py-2 hover:text-gold transition-colors">Gutter Cleaning</Link>
                                        <Link onClick={() => setIsMobileMenuOpen(false)} href="/services/gutter-guards" className="block py-2 hover:text-gold transition-colors">Gutter Guard Installation</Link>
                                    ...
                                    <div className="space-y-2 pt-2 border-t border-gray-50">
                                        ...
                                        <Link onClick={() => setIsMobileMenuOpen(false)} href="/services/barn-cleaning" className="block py-2 hover:text-gold transition-colors">Barn &amp; Agricultural Cleaning</Link>
