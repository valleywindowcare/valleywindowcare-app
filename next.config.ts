      ...
      if (parts.length >= 2) {
        ...
        try {
          ...
          if (normalizedSource && normalizedSource !== '/' && normalizedSource !== normalizedDest) {
            const cleanDestKey = normalizedDest.replace(/\{\/\}\?$/, '');
            const terminalDest = legacyToNestedMap[cleanDestKey] || legacyToNestedMap[`${cleanDestKey}{/}?`] || normalizedDest;
...
const legacyToNestedMap: Record<string, string> = {
  ...
  "/blog/hiring-window-cleaners-what-you-should-know": "/blog/hiring-a-window-cleaner-guide",
  "/blog/how-to-measure-your-windows-for-blinds": "/blog/how-to-measure-windows-for-blinds",
  "/paver-patio-restorations": "/services/paver-patio-restorations",
  "/services/soft-wash-green-bay": "/services/house-washing",
  "/services/window-cleaning-green-bay": "/services/window-cleaning",
  "/services/permanent-lighting-green-bay-wi": "/services/permanent-led-lighting",
  "/services/commercial-exterior-cleaning": "/services/commercial-pressure-washing",
  "/services/soft-washing-company-in-green-bay-wisconsin": "/services/house-washing",
  ...
  "/power-washing{/}?": "https://valleyexteriorpros.com/services/pressure-washing",
  ...
  "/rust-removal-in-green-bay-wisconsin{/}?": "/services/rust-removal",
  "/paver-patio-restorations-in-green-bay-wisconsin{/}?": "/services/paver-patio-restorations",
  "/expert-exterior-cleaning-for-apartment-complexes-in-green-bay-wisconsin{/}?": "/services/hoa-services",
  ...
  "/soft-washing-company-in-green-bay-wisconsin{/}?": "/services/house-washing",
  ...
  "/permanent-lighting-solutions-green-bay-wi{/}?": "/services/permanent-led-lighting",
  ...
  "/solar-panel-cleaning-in-green-bay-wisconsin{/}?": "/services/solar-panel-cleaning",
  ...
  "/smart-lighting-popup-content-draft-only{/}?": "/services/permanent-led-lighting",
  ...
  "/eco-friendly-exterior-cleaning-green-bay{/}?": "/blog/eco-friendly-exterior-cleaning-green-bay",
  ...
  "/permanent-led-smart-lighting-solutions-in-green-bay-wi{/}?": "/services/permanent-led-lighting",
  ...
  "/hiring-a-window-cleaner-guide{/}?": "/blog/hiring-a-window-cleaner-guide",
...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    const staticRedirects = Object.entries(legacyToNestedMap)
      ...
      .filter((r) => {
        if (seenStatic.has(r.source)) return false;
        seenStatic.add(r.source);
        return true;
      });
